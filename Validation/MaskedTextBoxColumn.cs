...
namespace DB
{
    ...
    public class MaskedTextBoxColumn : DataGridViewColumn
    {
        ...
        /// <summary>
        /// Контролює, чи слід включати літерали (не підказки) у вивід властивості Text для щойно введених даних у комірку цього типу.
        /// Додаткову інформацію дивіться в документації з елемента керування MaskedTextBox. </summary>
